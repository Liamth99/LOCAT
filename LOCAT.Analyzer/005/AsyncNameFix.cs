...
namespace LOCAT.Analyzer._005;

[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(AsyncNameFix)), Shared]
public class AsyncNameFix : CodeFixProvider
{
    /// <inheritdoc />
    public override ImmutableArray<string> FixableDiagnosticIds { get; } = ["LOCAT005"];
